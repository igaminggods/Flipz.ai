...
export default function QuickGuideSlots(){
  const steps = [
    {t:"Access Gateway", d:"Use the gateway link above"},
    {t:"Create Account", d:"Register a new account"},
    {t:"Find Slot", d:"Open the slot game"},
    {t:"Set Bet Value", d:"Use the exact bet amount"},
    {t:"Use Flipz AI", d:"Use our scan to pick optimal spins"},
    {t:"Time Limit", d:"Play before the window closes"},
  ];
  return (
